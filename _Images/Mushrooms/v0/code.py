...
view1 = displayio.Group(x = 0, y = 0) # Group for View 1 objects
...
temp_label = Label(font, color = GREEN)
...
# Create the text label
humidity_label = Label(font, text="", color = GREEN)
...
# Create the text label
pressure_label = Label(font, text="", color = GREEN)
...
# Create the text label
voc_label = Label(font, text="", color = GREEN)
